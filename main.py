        ...
        if msg.get("event") == "start":
            ...
            config = {
                ...
                "system_instruction": session.get(
                    "systemPrompt",
                    "You are Ava, a friendly receptionist for Sunlight Solar. Always speak immediately and clearly. Start every conversation with a greeting and ask if the caller is the homeowner. Do not wait for input before speaking."
                ),
                "speech_config": {"voice_config": {"prebuilt_voice_config": {"voice_name": "Puck"}}},
                # "tools": [_get_tools_config()],  # commented out
            }
